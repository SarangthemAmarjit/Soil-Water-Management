                            ...
                            child: Column(
                              children: [
                                                                ...
                                                                ? Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Expanded(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Card(
                                                                            shape:
                                                                                RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(color: Colors.black.withOpacity(0.5))),
                                                                            elevation:
                                                                                5,
                                                                            child:
                                                                                SizedBox(
                                                                      ...
                                                                      ElevatedButton(
                                                                        style: ButtonStyle(
                                                                            shape:
                                                                                MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(15), side: const BorderSide(color: Colors.red))),
                                                                            backgroundColor: const MaterialStatePropertyAll(Color.fromARGB(255, 149, 219, 153))),
                                ...
                                VerticalLinearGauge(
                                    ...
                                    phlevel: controller.latestfeeddata!.field7)
                              ],
                            ),
                          ),
                        ),
